...
static bool resolveLibs()
{
    if (!pDwmIsCompositionEnabled) {
        ...
        pDwmenableAeroWindow = (PtrDwmenableAeroWindow)dwmLib.resolve("DwmEnableBlurBehindWindow");//"DwmenableAeroWindow");
...
void QtWin::blurWidget(QWidget *widget)
{
    if (NULL == widget)
    {
        return;
    ...
    if (isCompositionEnabled()) {
        //extendFrameIntoClientArea(widget);
        enableAeroWindow(widget);
