...
windowFrame::windowFrame(QWidget *parent, Qt::WindowFlags f) : NoFrameDialog(parent, f)
{
    ...
    m_CloseButton.setPixmap(QPixmap(":/controls_res/close.png"));
    m_MinButton.setPixmap(QPixmap(":/controls_res/minimum.png"));
    m_MaxButton.setPixmap(QPixmap(":/controls_res/maximum.png"));
...
void windowFrame::showBeforeSize()
{
    ...
    resize(m_sizeBefore);
    move(m_pointBefore);
    QPixmap pixmap(":/controls_res/maximum.png");
...
void windowFrame::showMaximized()
{
    ...
    QPixmap pixmap(":/controls_res/resume.png");
    m_MaxButton.setPixmap(pixmap);
}
